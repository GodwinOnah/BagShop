...
namespace infrastructure.Migrations.Products
{
    ...
    public partial class InitialStore : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //         advert = table.Column<string>(type: "text", nullable: true),
            ...
            //         id = table.Column<int>(type: "integer", nullable: false)
            //             .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            //         delName = table.Column<string>(type: "text", nullable: true),
            //         delTime = table.Column<string>(type: "text", nullable: true),
            //         delDescription = table.Column<string>(type: "text", nullable: true),
            //         delPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
            //     },
            //     constraints: table =>
            //     {
            ...
            //         address_middleName = table.Column<string>(type: "text", nullable: true),
            ...
            //         prodPicture = table.Column<string>(type: "text", nullable: true),
            //         prodDescription = table.Column<string>(type: "text", nullable: true),
            //         prodPrice = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            //         id = table.Column<int>(type: "integer", nullable: false)
            //             .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            //         productOrdered_id = table.Column<int>(type: "integer", nullable: true),
            //         productOrdered_prodName = table.Column<string>(type: "text", nullable: true),
            //         productOrdered_prodPicture = table.Column<string>(type: "text", nullable: true),
            //         itemPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            //         quantity = table.Column<int>(type: "integer", nullable: false),
            //         AdminOrderid = table.Column<int>(type: "integer", nullable: true),
